...
plt.tight_layout()
save_path = os.path.join(save_dir, sub, f'{sub}_p7_RL_session_6.png')
plt.savefig(save_path)
plt.show()
...
plt.tight_layout()
save_path = os.path.join(save_dir, sub, f'{sub}_p10_GRU_session_6.png')
plt.savefig(save_path)
plt.show()
...
plt.tight_layout()
save_path = os.path.join(save_dir, sub, f'{sub}_p16_disRNN_latents_choices_session_6.png')
plt.savefig(save_path)
plt.show()
...
plt.tight_layout()
save_path = os.path.join(save_dir, sub, f'{sub}_p19_HybridRNN_session_6.png')
plt.savefig(save_path)
plt.show()
